...
<html lang="en">
	<head>
		...
		<link href="/vendors/happy-scroll/css/bootstrap.min.css" rel="stylesheet">
		<!--[if lt IE 9]>
			<script src="//html5shim.googlecode.com/svn/trunk/html5.js"></script>
		<![endif]-->
		<link href="/vendors/happy-scroll/css/styles.css" rel="stylesheet">
	</head>
	<body>
...
<header class="masthead">
    ...
    <div class="row">
      <div class="col-sm-6">
        <h1><a href="#" title="Bootstrap Template"><?php echo (isset($title)) ? $title : "" ;?></a>
          <p class="lead"><?php echo (isset($content)) ? $content : "" ;?></p></h1>
      </div>
      <div class="col-sm-6">
    ...
    <div class="container">
      ...
      <div class="collapse navbar-collapse">
        <ul class="nav navbar-nav nav-justified">
          ...
          <li><a href="#section1"><strong>Big Brand</strong></a></li>
...
<div class="container" id="section3">
      ...
      <img src="/vendors/happy-scroll/assets/example/bg_smartphones.jpg" class="img-responsive">
...
<div class="container">
      ...
      <ul class="list-inline center-block">
        <li><a href="http://facebook.com/bootply"><img src="/vendors/happy-scroll/assets/example/soc_fb.png"></a></li>
        <li><a href="http://twitter.com/bootply"><img src="/vendors/happy-scroll/assets/example/soc_tw.png"></a></li>
        <li><a href="http://google.com/+bootply"><img src="/vendors/happy-scroll/assets/example/soc_gplus.png"></a></li>
        <li><a href="http://pinterest.com/in1"><img src="/vendors/happy-scroll/assets/example/soc_pin.png"></a></li>
      </ul>
...
<ul class="nav pull-right scroll-top">
  <li><a href="#" title="Scroll to top"><i class="glyphicon glyphicon-chevron-up"></i></a></li>
	...
	<!-- script references -->
		...
		<script src="/vendors/happy-scroll/js/bootstrap.min.js"></script>
		<script src="http://maps.googleapis.com/maps/api/js?sensor=false&extension=.js&output=embed"></script>
		<script src="/vendors/happy-scroll/js/scripts.js"></script>
	</body>
</html><!-- /foot.html.twig -->
