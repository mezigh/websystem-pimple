						...
						<ul>
							...
							<li>
								<div class="dropdown choose-country">
									<a class="#" data-toggle="dropdown" href="#"><img src="/multi-purpose-master/img/flags/fr.png" alt="France"> FR</a>
        ...
        <div class="section">
	        <div class="container">
				<div class="row service-wrapper-row">
        			<div class="col-sm-4">
        				<div class="service-image">
        					<img src="/multi-purpose-master/img/homepage-slider/slide2.png" alt="Color Schemes">
        				</div>
        			</div>
        			<div class="col-sm-8">
				...
				<div class="row service-wrapper-row">
        			<div class="col-sm-4">
        				<div class="service-image">
        					<img src="/multi-purpose-master/img/less-logo.png" alt="LESS CSS">
        				</div>
        			</div>
        			<div class="col-sm-8">
    					<h3>LESS CSS</h3>
				...
				<div class="row service-wrapper-row">
        			<div class="col-sm-4">
        				<div class="service-image">
        					<img src="/multi-purpose-master/img/homepage-slider/slide1.png" alt="Responsive">
        				</div>
        			</div>
        			<div class="col-sm-8">
				...
				<div class="row service-wrapper-row">
        			<div class="col-sm-4">
        				<div class="service-image">
        					<img src="/multi-purpose-master/img/flags.png" alt="Flags">
        				</div>
        			</div>
        			<div class="col-sm-8">
